...
e.custom({
  ...
  astral2('astralsorcery:marble_raw', 4, 'minecraft:charcoal', 1, 'astralsorcery:black_marble_raw', 8, 40)
  ...
  // Astral 4 Items
  astral4('minecraft:oak_planks', 1, 'astralsorcery:marble_raw', 1, 'minecraft:gold_nugget', 1, 'astralsorcery:glass_lens', 1, 'astralsorcery:spectral_relay', 2, 70)
