...
e.custom({
  ...
  mystic(1750, 'mysticalagriculture:awakened_draconium_essence', 9, 'draconicevolution:awakened_draconium_nugget', 6)
  mystic(1750, 'mysticalagriculture:spirited_crystal_essence', 9, 'powah:crystal_spirited', 6)
  mystic(1750, 'mysticalagriculture:niotic_crystal_essence', 9, 'powah:crystal_niotic', 6)
  mystic(1750, 'mysticalagriculture:nitro_crystal_essence', 9, 'powah:crystal_nitro', 6)
  mystic(1750, 'mysticalagriculture:apatite_essence', 8, 'thermal:apatite', 12)
  mystic(1750, 'mysticalagriculture:aquamarine_essence', 8, 'astralsorcery:aquamarine', 12)
  mystic(1750, 'mysticalagriculture:ender_biotite_essence', 8, 'quark:biotite', 12)
  mystic(1750, 'mysticalagriculture:lapis_lazuli_essence', 8, 'minecraft:lapis_lazuli', 12)
  mystic(1750, 'mysticalagriculture:constantan_essence', 8, 'thermal:constantan_ingot', 6)
  mystic(1750, 'mysticalagriculture:nickel_essence', 8, 'thermal:nickel_ingot', 6)
  mystic(1750, 'mysticalagriculture:steel_essence', 8, 'mekanism:ingot_steel', 6)
  mystic(1750, 'mysticalagriculture:silicon_essence', 3, 'refinedstorage:silicon', 12)
})
