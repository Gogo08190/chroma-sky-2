...
e.custom({
  ...
  mystic(2000, 'mysticalagriculture:awakened_draconium_essence', 9, 'draconicevolution:awakened_draconium_nugget', 7)
  mystic(2000, 'mysticalagriculture:spirited_crystal_essence', 9, 'powah:crystal_spirited', 7)
  mystic(2000, 'mysticalagriculture:niotic_crystal_essence', 9, 'powah:crystal_niotic', 7)
  mystic(2000, 'mysticalagriculture:nitro_crystal_essence', 9, 'powah:crystal_nitro', 7)
  mystic(2000, 'mysticalagriculture:apatite_essence', 8, 'thermal:apatite', 14)
  mystic(2000, 'mysticalagriculture:aquamarine_essence', 8, 'astralsorcery:aquamarine', 14)
  mystic(2000, 'mysticalagriculture:ender_biotite_essence', 8, 'quark:biotite', 14)
  mystic(2000, 'mysticalagriculture:lapis_lazuli_essence', 8, 'minecraft:lapis_lazuli', 14)
  ...
  mystic(2000, 'mysticalagriculture:chaos_essence', 8, 'draconicevolution:small_chaos_frag', 1)
  mystic(2000, 'mysticalagriculture:silicon_essence', 3, 'refinedstorage:silicon', 14)
})
