events.listen('recipes', function (e) {
    ...
    gardenvanilla('minecraft:sugar_cane', 2, 'minecraft:sugar_cane', 'snad:snad', 'stacking', 'minecraft:sugar_cane')
    gardenvanilla('minecraft:sugar_cane', 3, 'minecraft:sugar_cane', 'chromasky:1x_compressed_sand', 'stacking', 'minecraft:sugar_cane')
    gardenvanilla('minecraft:sugar_cane', 4, 'minecraft:sugar_cane', 'chromasky:2x_compressed_sand', 'stacking', 'minecraft:sugar_cane')
    gardenvanilla('minecraft:sugar_cane', 5, 'minecraft:sugar_cane', 'chromasky:3x_compressed_sand', 'stacking', 'minecraft:sugar_cane')
    ...
    gardenvanilla('minecraft:cactus', 2, 'minecraft:cactus', 'snad:snad', 'stacking', 'minecraft:cactus')
    gardenvanilla('minecraft:cactus', 3, 'minecraft:cactus', 'chromasky:1x_compressed_sand', 'stacking', 'minecraft:cactus')
    gardenvanilla('minecraft:cactus', 4, 'minecraft:cactus', 'chromasky:2x_compressed_sand', 'stacking', 'minecraft:cactus')
    gardenvanilla('minecraft:cactus', 5, 'minecraft:cactus', 'chromasky:3x_compressed_sand', 'stacking', 'minecraft:cactus')
    ...
    gardenvanilla('minecraft:chorus_fruit', 2, 'minecraft:chorus_flower', 'chromasky:1x_compressed_endstone', 'chorus', 'minecraft:chorus_flower')
    gardenvanilla('minecraft:chorus_fruit', 3, 'minecraft:chorus_flower', 'chromasky:2x_compressed_endstone', 'chorus', 'minecraft:chorus_flower')
