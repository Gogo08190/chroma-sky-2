...
event.remove({ output: 'miniutilities:angel_ring' })
  ...
  event.shapeless('extendedcrafting:crystaltine_ingot', '9x extendedcrafting:crystaltine_nugget');
  event.shapeless('9x extendedcrafting:crystaltine_ingot', 'extendedcrafting:crystaltine_block');
});
