onEvent('recipes', event => {
  ...
  event.recipes.bloodmagic.alchemytable('matc:supremium_crystal', [Item.of('matc:imperium_crystal', '{Damage:0}').weakNBT(), 'mysticalagriculture:supremium_gemstone_block', 'mysticalagriculture:supremium_gemstone_block', 'mysticalagriculture:supremium_gemstone_block', 'mysticalagriculture:supremium_gemstone', 'mysticalagriculture:supremium_gemstone']).syphon(3658).upgradeLevel(4)
